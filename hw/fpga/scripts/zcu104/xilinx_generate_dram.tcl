...
################################################################
# This is a generated script based on design: dram_wrapper
#
...
# source dram_wrapper_script.tcl
...
\
  ...
  # Create instance: axi_lite_from_mem_wr_0, and set properties
  set axi_lite_from_mem_wr_0 [ create_bd_cell -type ip -vlnv user.org:user:axi_lite_from_mem_wrapper:1.0 axi_lite_from_mem_wr_0 ]
  ...
  connect_bd_intf_net -intf_net axi_lite_from_mem_wr_0_M_AXI [get_bd_intf_pins axi_lite_from_mem_wr_0/M_AXI] [get_bd_intf_pins axi_smc/S00_AXI]
  ...
  [get_bd_pins axi_lite_from_mem_wr_0/clk_i] \
  ...
  assign_bd_address -offset 0x00000000 -range 0x80000000 -target_address_space [get_bd_addr_spaces axi_lite_from_mem_wr_0/M_AXI] [get_bd_addr_segs zynq_ultra_ps_e_0/SAXIGP2/HP0_DDR_LOW] -force
  assign_bd_address -offset 0xFF000000 -range 0x01000000 -target_address_space [get_bd_addr_spaces axi_lite_from_mem_wr_0/M_AXI] [get_bd_addr_segs zynq_ultra_ps_e_0/SAXIGP2/HP0_LPS_OCM] -force
  assign_bd_address -offset 0xC0000000 -range 0x20000000 -target_address_space [get_bd_addr_spaces axi_lite_from_mem_wr_0/M_AXI] [get_bd_addr_segs zynq_ultra_ps_e_0/SAXIGP2/HP0_QSPI] -force
